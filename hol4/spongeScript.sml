...
THEN FULL_SIMP_TAC std_ss [GSYM LENGTH_NIL]
...
(*
Following NIST FIPS-202:
SHA3-224(M) = KECCAK [448] (M || 01, 224);
we need to append 01 to every m
*)
val SHA3_APPEND_def = 
  Define 
   `SHA3_APPEND msg  = msg ++ [F] ++ [T]`;
 ...
 Define
  `Hash f initial_state  msg =
    Output (Absorb f initial_state
         (SplittoWords (Pad ( dimindex(:'r) ) (SHA3_APPEND msg))
